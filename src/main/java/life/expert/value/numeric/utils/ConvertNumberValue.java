...
enum ConvertNumberValue
	...
	public static <T extends Number> T of( Class<T> numberType ,
	                                       Number number )
		{
		return INSTANCE.convert( numberType ,
		                         number );
		}
	...
	public static <T extends Number> T ofExact( Class<T> numberType ,
	                                            Number number )
		{
		return INSTANCE.convertExact( numberType ,
		                              number );
		}
	...
	convertIMap.put( BigDecimal.class ,
	                 new ConvertNumberValueBigDecimal() );
	convertIMap.put( BigInteger.class ,
	                 new ConvertNumberValueBigInteger() );
	convertIMap.put( Float.class ,
	                 new ConvertNumberValueFloat() );
	convertIMap.put( Double.class ,
	                 new ConvertNumberValueDouble() );
	convertIMap.put( Long.class ,
	                 new ConvertNumberValueLong() );
	convertIMap.put( Integer.class ,
	                 new ConvertNumberValueInteger() );
	convertIMap.put( Short.class ,
	                 new ConvertNumberValueShort() );
	convertIMap.put( Byte.class ,
	                 new ConvertNumberValueByte() );
	convertIMap.put( AtomicInteger.class ,
	                 new ConvertNumberValueAtomicInteger() );
	convertIMap.put( AtomicLong.class ,
	                 new ConvertNumberValueAtomicLong() );
	}
	}